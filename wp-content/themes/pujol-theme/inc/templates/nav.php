<div class="grid__container grid__container--no-padding header__container--hover header__mobile-container header--padding" id="header-fixed_JS">
     ...
     <a href="<?php echo BLOGURL ?> ">
          <h1 class="header__title--small header__title--small-responsive" id='title--small_JS'> <?= __('pujol',TRANSDOMAIN) ?> </h1>
     </a>
     ...
     <nav class="header__container header__mobile mobile_JS" id="header__navbar__JS">
          <ul class="header__menu">
               <a  class="header__mobile--item menu-link menu-link-home" href="#us"><li> <?= __('Nosotros',TRANSDOMAIN) ?></li></a>
               <a  class="header__mobile--item menu-link menu-link-home" href="#reservations"><li> <?= __('Reservaciones',TRANSDOMAIN) ?></li></a>
               <a  class="header__mobile--item menu-link menu-link-home" href="#menu"><li> <?= __('Menú',TRANSDOMAIN) ?></li></a>
               <a  class="header__mobile--item menu-link menu-link-home" href="#contact"><li> <?= __('Contacto',TRANSDOMAIN) ?></li></a>
          </ul>

          <a href="<?php echo BLOGURL ?> ">
               <h1 class="header__title--small header__title--small-no-responsive" id='title--small_JS'> <?= __('pujol',TRANSDOMAIN) ?></h1>
          </a>
